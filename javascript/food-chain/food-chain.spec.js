...
describe('Food Chain', function () {
  ...
  it('verse is an invalid line number', function () {
    expect( function () {
      /* eslint no-unused-vars: ["error", { "varsIgnorePattern": "[iI]gnored" }]*/
      song.verse('blah');
    }).toThrow(new Error('Verse must be a number'));
  });
  ...
  it('multiple verses are invalid line numbers', function () {
    expect( function () {
      /* eslint no-unused-vars: ["error", { "varsIgnorePattern": "[iI]gnored" }]*/
      song.verses('foo', 'bar');
    }).toThrow(new Error('Verses must be a number'));
  });
